        ...
        for field_name in key_fields:
            if field_name in df.columns:
                if field_name in ['SLRN', 'Account Number', 'Meter Number', 'Meter SLRN']:
                    metrics = calculate_data_quality_metrics(user_df, field_name)
                elif field_name == 'Phone Number':
                    metrics = calculate_phone_number_metrics(user_df, field_name, corresponding_meter_field='Meter Number')
